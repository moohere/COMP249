 ...
 * Assignment #2 <p>
 * Due 25/07/18 <p>
 * Creates a Striker object and contains appropriate methods. 
 * <p>
 * A soccer player name, date of birth, club name, country name, the number of yellow cards, the number of red cards,
 * the number of games played, the number of goals scored, the number of assists, the number of shots on target, and the goals to shots ratio.
 */
public class Striker extends Forward{
	 ...
	 * @param goalsToShotsRatio The ratio for the goals to shots of the player
	 */
	...
	/**
	 * Copy constructor for Striker. 
	 */
	public Striker(Striker copy) {
		this(copy.name, copy.dob, copy.clubName, copy.countryName, copy.numYellowCards, 
				copy.numRedCards, copy.gamesPlayed, copy.goalsScored, copy.numAssists, copy.shotsOnTarget, copy.goalsToShotsRatio);
	}
	...
	/**
	 * The toString method is used to print the information about the Striker player.
	 */
	public String toString() {
		return (this.name + " is a striker.\nHe is from " + this.getCountryName()+ " and plays for " + this.getClubName()+" club.\n"
				...
				this.getShotsOnTarget() + " shots on target and has a goals to shot ratio of " + this.getGoalsToShotsRatio()+"\n");
	}
	...
	public boolean equals(Object other) {
		...
		if(other == null || other.getClass() != this.getClass())
			...
			Striker otherTest = (Striker) other;
			return (this.name.equals(otherTest.name) && this.dob == otherTest.dob && this.clubName.equals(otherTest.clubName) &&
					...
					this.numAssists == otherTest.numAssists && this.shotsOnTarget == otherTest.shotsOnTarget && this.goalsToShotsRatio == otherTest.goalsToShotsRatio);
		}
	}
